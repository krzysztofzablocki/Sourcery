...
- `--config` [default: current path] - Path to config file. File or Directory. When you assign Directory, implicitly config file is assigned `.sourcery.yml` in Directory. See [Configuration file](#configuration-file).
