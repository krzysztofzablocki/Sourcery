...
Template used to generate equality for all types that either conform the protocol or are annotated with `AutoEquatable`, allowing us to avoid writing boilerplate code.
