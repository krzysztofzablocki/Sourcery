...
class AsyncThrowingVariablesProtocolMock: AsyncThrowingVariablesProtocol {
    ...
    var titleThrowableError: (any Error)?
    ...
    var firstNameThrowableError: (any Error)?
...
class ExampleVarargMock: ExampleVararg {
    ...
    var stringKeyStringArgsAnyCVarArgStringCallsCount = 0
    var stringKeyStringArgsAnyCVarArgStringCalled: Bool {
        return stringKeyStringArgsAnyCVarArgStringCallsCount > 0
    }
    var stringKeyStringArgsAnyCVarArgStringReceivedArguments: (key: String, args: [any CVarArg])?
    var stringKeyStringArgsAnyCVarArgStringReceivedInvocations: [(key: String, args: [any CVarArg])] = []
    var stringKeyStringArgsAnyCVarArgStringReturnValue: String!
    var stringKeyStringArgsAnyCVarArgStringClosure: ((String, [any CVarArg]) -> String)?

    func string(key: String, args: any CVarArg...) -> String {
        stringKeyStringArgsAnyCVarArgStringCallsCount += 1
        stringKeyStringArgsAnyCVarArgStringReceivedArguments = (key: key, args: args)
        stringKeyStringArgsAnyCVarArgStringReceivedInvocations.append((key: key, args: args))
        if let stringKeyStringArgsAnyCVarArgStringClosure = stringKeyStringArgsAnyCVarArgStringClosure {
            return stringKeyStringArgsAnyCVarArgStringClosure(key, args)
        } else {
            return stringKeyStringArgsAnyCVarArgStringReturnValue
        }
    }
...
class MultiClosureProtocolMock: MultiClosureProtocol {
    ...
    var setClosureNameStringClosureEscapingVoidVoidClosure: ((String, () -> Void) -> Void)?
...
public class ProtocolWithMethodWithGenericParametersMock: ProtocolWithMethodWithGenericParameters {
    ...
    public var executeParamResultIntAnyErrorResultStringAnyErrorCallsCount = 0
    public var executeParamResultIntAnyErrorResultStringAnyErrorCalled: Bool {
        return executeParamResultIntAnyErrorResultStringAnyErrorCallsCount > 0
    }
    public var executeParamResultIntAnyErrorResultStringAnyErrorReceivedParam: (Result<Int, any Error>)?
    public var executeParamResultIntAnyErrorResultStringAnyErrorReceivedInvocations: [(Result<Int, any Error>)] = []
    public var executeParamResultIntAnyErrorResultStringAnyErrorReturnValue: Result<String, any Error>!
    public var executeParamResultIntAnyErrorResultStringAnyErrorClosure: ((Result<Int, any Error>) -> Result<String, any Error>)?

    public func execute(param: Result<Int, any Error>) -> Result<String, any Error> {
        executeParamResultIntAnyErrorResultStringAnyErrorCallsCount += 1
        executeParamResultIntAnyErrorResultStringAnyErrorReceivedParam = param
        executeParamResultIntAnyErrorResultStringAnyErrorReceivedInvocations.append(param)
        if let executeParamResultIntAnyErrorResultStringAnyErrorClosure = executeParamResultIntAnyErrorResultStringAnyErrorClosure {
            return executeParamResultIntAnyErrorResultStringAnyErrorClosure(param)
        } else {
            return executeParamResultIntAnyErrorResultStringAnyErrorReturnValue
        }
    }
