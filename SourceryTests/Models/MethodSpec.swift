            ...
            describe("When testing equality") {
                ...
                context("given different items") {
                    it("is not equal") {
                        ...
                        expect(sut).toNot(equal(Method(selectorName: "foo(some: Int)", parameters: [MethodParameter(name: "some", typeName: TypeName("Int"))], returnTypeName: TypeName("Void"), throws: true, accessLevel: .internal, isStatic: false, isClass: false, isFailableInitializer: false, annotations: [:])))
