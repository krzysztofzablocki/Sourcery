    ...
    override func spec() {
        describe ("Sourcery") {
            ...
            context("given a single template") {
                ...
                context("given a code generated file") {
                    fit("ignores files that are marked with Generated by Sourcery") {
                        let sourcePath = outputDir + Sourcery().generatedPath(for: templatePath)
                        ...
                        let result = try? sourcePath.read(.utf8)
                        expect(result?.withoutWhitespaces).to(equal(Sourcery.generationHeader.withoutWhitespaces))
                    }
                }
