                ...
                context("given struct") {
                    ...
                    it("extracts generic struct properly") {
                        expect(parse("struct Foo<Something> { }"))
                                .to(equal([
                                    Struct(name: "Foo", isGeneric: true, genericTypeParameters: [Generic(name: "Something")])
                                          ]))

                        expect(parse("struct Foo<  A  , B,C> { }"))
                            .to(equal([
                                Struct(name: "Foo", isGeneric: true, genericTypeParameters: [Generic(name: "A"), Generic(name: "B"), Generic(name: "C")])
                                ]))

                        expect(parse("struct Foo<A : Equatable & Codable, B:Codable,\n\nC > { }"))
                            .to(equal([
                                Struct(name: "Foo", isGeneric: true, genericTypeParameters: [Generic(name: "A", constraints: [GenericTypeParameterConstraint(name: TypeName("Equatable")), GenericTypeParameterConstraint(name: TypeName("Codable"))]), Generic(name: "B", constraints: [GenericTypeParameterConstraint(name: TypeName("Codable"))]), Generic(name: "C")])
                                ]))
                    }
...
""")
                        let expected = Class(name: "Foo", isGeneric: true, genericTypeParameters: [Generic(name: "A", constraints: [GenericTypeParameterConstraint(name: TypeName("Equatable")), GenericTypeParameterConstraint(name: TypeName("Codable"))]), Generic(name: "B", constraints: [GenericTypeParameterConstraint(name: TypeName("Baz<A>")), GenericTypeParameterConstraint(name: TypeName("Comparable")), GenericTypeParameterConstraint(name: TypeName("Decodable"))]), Generic(name: "C", constraints: [GenericTypeParameterConstraint(name: TypeName("CustomStringConvertible")), GenericTypeParameterConstraint(name: TypeName("CustomDebugStringConvertible"))])])
                        let method = Method(name: "f<T : Codable>(_ t : T)", selectorName: "f(_:)", parameters: [MethodParameter(argumentLabel: nil, name: "t", typeName: TypeName("T"), type: nil, defaultValue: nil, annotations: [:], isInout: false)], returnTypeName: TypeName("T where T : Equatable"), throws: false, rethrows: false, accessLevel: .internal, isStatic: false, isClass: false, isFailableInitializer: false, definedInTypeName: TypeName("Foo"), genericTypeParameters: [Generic(name: "T", constraints: [GenericTypeParameterConstraint(name: TypeName("Codable")), GenericTypeParameterConstraint(name: TypeName("Equatable"))])])
                    ...
                    it("extracts generics with complex types with commas") {
                        ...
                        let expected = Class(name: "Foo", isGeneric: true, genericTypeParameters: [Generic(name: "A", constraints: [GenericTypeParameterConstraint(name: TypeName("[(String, Int)]"))])])
                        expect(result).to(equal([expected]))
                    }
                }
...
""")
                        ...
                        let method = Method(name: "doSomething<T : Bar>(_ value : T)", selectorName: "doSomething(_:)", parameters: [MethodParameter(argumentLabel: nil, name: "value", typeName: TypeName("T"), type: nil, defaultValue: nil, annotations: [:], isInout: false)], returnTypeName: TypeName("Int where T : Equatable"), throws: false, rethrows: false, accessLevel: .internal, isStatic: false, isClass: false, isFailableInitializer: false, definedInTypeName: TypeName("Foo"), genericTypeParameters: [Generic(name: "T", constraints: [GenericTypeParameterConstraint(name: TypeName("Bar")), GenericTypeParameterConstraint(name: TypeName("Equatable"))])])
