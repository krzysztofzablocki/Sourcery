...
//                    }
//                    
//                    it("extracts and preserves associatedtype generic requirements correctly") {
//                        let parsedProtocol = parse(
//                        """
//                        protocol SomeType {
...
//                        """).last
//
//                        let givenTypealias = Typealias(aliasName: "List", typeName: TypeName(name: "ListType"))
//                        let expectedProtocol = Protocol(name: "SomeType", typealiases: [givenTypealias])
//                        givenTypealias.parent = expectedProtocol
//                        let associatedTypeType = Type(name: "ListType")
//                        associatedTypeType.genericRequirements = [
//                            GenericRequirement(
//                                leftType: AssociatedType(name: "List.Element"),
//                                rightType: GenericTypeParameter(typeName: TypeName(name: "Domain")),
//                                relationship: .equals
//                            )
//                        ]
//                        expectedProtocol.associatedTypes["List"] = AssociatedType(
//                          name: "List",
//                          typeName: TypeName(
//                            name: givenTypealias.aliasName,
//                            actualTypeName: givenTypealias.typeName
//                          ),
//                          type: associatedTypeType
//                        )
//                        expect(parsedProtocol).to(equal(expectedProtocol))
//                        let actualTypeName = (parsedProtocol as? SourceryProtocol)?.associatedTypes.first?.value.typeName?.actualTypeName
//                        expect(actualTypeName).to(equal(givenTypealias.actualTypeName))
//                        let genericRequirement = (parsedProtocol as? SourceryProtocol)?.associatedTypes.first?.value.type?.genericRequirements.first
//                        expect(genericRequirement).to(equal(associatedTypeType.genericRequirements.first!))
//                    }
                }
...
//                    }
                    ...
                    it("resolves protocol generic requirement types and inherits associated types") {
                        ...
                        expect(parsedProtocol?.genericRequirements[0].rightType.type).to(beNil())
