                    ...
                    it("extracts elements properly") {
                        ...
                        expect(variable?.typeName.tuple).to(equal(
                            TupleType(name: "(a: Int, b: Int, String, _: Float, literal: [String: [String: Float]], generic: Dictionary<String, Dictionary<String, Float>>, closure: (Int) -> (Int -> Int), tuple: (Int, Int))", elements: [
                                ...
                                TupleElement(name: "generic", typeName: TypeName("Dictionary<String, Dictionary<String, Float>>", generic: GenericType(name: "Dictionary", referencedTypeNames: [TypeName("String"), TypeName("Dictionary<String, Float>", generic: GenericType(name: "Dictionary", referencedTypeNames: [TypeName("String"), TypeName("Float")]))]), dictionary: DictionaryType(name: "Dictionary<String, Dictionary<String, Float>>", valueTypeName: TypeName("Dictionary<String, Float>", generic: GenericType(name: "Dictionary", referencedTypeNames: [TypeName("String"), TypeName("Float")]), dictionary: DictionaryType(name: "Dictionary<String, Float>", valueTypeName: TypeName("Float"), keyTypeName: TypeName("String"))), keyTypeName: TypeName("String")))),
